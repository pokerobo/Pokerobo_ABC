...
void AbcDebugLogger::debug(char* s0, char* s1, char* s2, char* s3, char* s4, char* s5, char* s6, char* s7, char* s8, char* s9,
...
void AbcDebugLoggable::setDebugEnabled(bool enabled) {
  _debugEnabled = enabled;
}

void AbcDebugLoggable::setDebugLogger(AbcDebugLogger* logger) {
  _logger = logger;
}

bool AbcDebugLoggable::isDebugEnabled() {
  return (_logger != NULL) && _debugEnabled;
}

AbcDebugLogger* AbcDebugLoggable::getLogger() {
  return _logger;
}
